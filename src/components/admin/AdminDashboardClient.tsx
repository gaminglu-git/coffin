...
import { useAdminTab } from "@/components/admin/AdminShellLayout";
...
interface AdminDashboardClientProps {
  initialDashboardData: DashboardOverviewData;
}

export function AdminDashboardClient({
  initialDashboardData,
}: AdminDashboardClientProps) {
  const tabContext = useAdminTab();
  const activeTab = tabContext?.activeTab ?? "dashboard";
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-gray-50 p-1.5 rounded-lg border border-gray-200">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCaseTypeFilter(e.target.value as CaseType | "alle")
                  }
