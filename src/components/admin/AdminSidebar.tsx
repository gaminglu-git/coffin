        ...
        <div className="w-full md:w-64 bg-mw-green-dark text-white flex flex-col shrink-0 z-20 shadow-xl h-full">
            ...
            <div className="flex-1 py-6 px-4 space-y-2 flex flex-col">
                <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition ${activeTab === "cases" ? "bg-mw-green shadow-md" : "hover:bg-mw-green/50"
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition ${activeTab === "tasks" ? "bg-mw-green shadow-md" : "hover:bg-mw-green/50"
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition ${activeTab === "handover" ? "bg-mw-green shadow-md" : "hover:bg-mw-green/50"
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition ${activeTab === "employees" ? "bg-mw-green shadow-md" : "hover:bg-mw-green/50"
                        }`}
                >
